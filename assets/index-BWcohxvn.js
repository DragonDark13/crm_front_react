...
const CustomDialog = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Dialog,
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { id: "custom-dialog-title", children: [
          title,
...
const fetchGetAllCategories = () => {
  return api.get("/categories").then((response) => response.data).catch((error) => {
...
const addProduct = (newProduct) => {
  return api.post("/product", newProduct).catch((error) => {
...
const addPurchase = (productId, purchaseData) => {
  return api.post(`/product/${productId}/purchase`, purchaseData).catch((error) => {
    console.error("Error adding purchase:", error);
    throw error;
  });
};
const addSale = (productId, saleData) => {
  return api.post(`/product/${productId}/sale`, saleData).catch((error) => {
